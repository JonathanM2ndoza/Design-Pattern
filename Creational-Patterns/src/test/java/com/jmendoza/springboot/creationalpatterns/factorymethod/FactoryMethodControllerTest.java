package com.jmendoza.springboot.creationalpatterns.factorymethod;
...
public class FactoryMethodControllerTest {
    ...
    public void getCircleGeometry() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("circle").value(78.54))
                .andExpect(MockMvcResultMatchers.jsonPath("rectangle").value(8.0));
    }
}
